    ...
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-12">
        <div className='col-span-7 flex flex-col justify-center text-center sm:text-left'>
          <h1 className="text-white mb-4 text-4xl sm:text-5x lg:text-6xl font-extrabold">
          ...
          <div>
          <button className='px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 bg-white hover:bg-slate-500 text-white'>
              <a href="">About Me</a>
            </button>
